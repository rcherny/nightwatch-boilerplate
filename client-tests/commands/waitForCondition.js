...
/*
signature is actually (condition, milliseconds, timeout, messages, callback)
browser.waitForCondition('return typeof "HARLO" != "undefined"', 8000, function(result) {
    this.verify.equal(result, true);
})
 */
...
CommandAction.prototype.check = function() {
    ...
    this.self.api.execute.call(this.client, this.condition, function(result) {
